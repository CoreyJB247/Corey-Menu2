...
-- Enable/Disable the adverts menu
Config.ShowAdverts = true

-- These are the adverts available in the menu
Config.Adverts = {
    { name = '24/7', icon = 'store' },
    { name = 'Ammunation', icon = 'gun' },
    { name = 'Bugstars', icon = 'bug' },
    { name = 'Cluckin\' Bell', icon = 'drumstick-bite' },
    { name = 'Downtown Cab Co.', icon = 'taxi' },
    { name = 'Dynasty 8', icon = 'house' },
    { name = 'Fleeca Bank', icon = 'building-columns' },
    { name = 'Gruppe6', icon = 'truck' },
    { name = 'Merry Weather', icon = 'shield' },
    { name = 'Limited Gasoline', icon = 'gas-pump' },
    { name = 'Liquor Ace', icon = 'beer-mug-empty' },
    { name = 'Smoke on the Water', icon = 'cannabis' },
    { name = 'Pegasus', icon = 'helicopter' },
    { name = 'Los Santos Customs', icon = 'wrench' },
    { name = 'Los Santos Traffic Info', icon = 'circle-info' },
    { name = 'Mors Mutual Insurance', icon = 'briefcase' },
    { name = 'PostOP', icon = 'box' },
    { name = 'Vanilla Unicorn', icon = 'champagne-glasses' },
    { name = 'Weazel News', icon = 'newspaper' },
    { name = 'Facebook', icon = 'thumbs-up' },
    { name = 'Life Invader', icon = 'mobile-screen' },
